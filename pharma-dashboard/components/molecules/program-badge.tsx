...
const STATUS_VARIANTS: Record<ProgramStatus, { className: string; label: string }> = {
  ...
  Terminated: { className: "bg-gray-500/10 text-gray-500 border-gray-500/20", label: "Terminated" },
  "Pending Approval": { className: "bg-purple-500/10 text-purple-500 border-purple-500/20", label: "Pending Approval" },
};
