...
describe('/api/users/[id]', () => {
  ...
  describe('GET', () => {
    it('should return user by id', async () => {
      ...
      const request = new NextRequest('http://localhost:3000/api/users/USR001');
    ...
    it('should return 404 when not found', async () => {
      ...
      const request = new NextRequest('http://localhost:3000/api/users/NONE');
  ...
  describe('DELETE', () => {
    it('should delete user', async () => {
      ...
      const request = new NextRequest('http://localhost:3000/api/users/USR001', { method: 'DELETE' });
    ...
    it('should return 404 when not found', async () => {
      ...
      const request = new NextRequest('http://localhost:3000/api/users/NONE', { method: 'DELETE' });
